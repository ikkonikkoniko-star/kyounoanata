 ...
 *   name    … 画面に出る色名
 *   hex     … 実際の色
 *   sheen   … 金属色だけ。単色だと金属に見えないので、照りのグラデーションを持たせる。
 *             明→暗→明の順に並べると金属らしくなる。この配列がある色は
 *             見本・服・小物すべてがグラデーションで塗られる。
